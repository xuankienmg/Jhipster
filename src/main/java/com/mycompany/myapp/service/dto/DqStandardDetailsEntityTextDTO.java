...
/**
 * A DTO for the {@link com.mycompany.myapp.domain.DqStandardDetailsEntityText} entity.
 */
public class DqStandardDetailsEntityTextDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DqStandardDetailsEntityTextDTO dqStandardDetailsEntityTextDTO = (DqStandardDetailsEntityTextDTO) o;
        if (dqStandardDetailsEntityTextDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), dqStandardDetailsEntityTextDTO.getId());
    }
    ...
    public String toString() {
        return "DqStandardDetailsEntityTextDTO{" +
            "id=" + getId() +
