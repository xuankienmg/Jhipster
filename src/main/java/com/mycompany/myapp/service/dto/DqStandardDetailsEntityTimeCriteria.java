...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.DqStandardDetailsEntityTime} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.DqStandardDetailsEntityTimeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /dq-standard-details-entity-times?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class DqStandardDetailsEntityTimeCriteria implements Serializable, Criteria {
    ...
    public DqStandardDetailsEntityTimeCriteria() {
    }

    public DqStandardDetailsEntityTimeCriteria(DqStandardDetailsEntityTimeCriteria other) {
    ...
    @Override
    public DqStandardDetailsEntityTimeCriteria copy() {
        return new DqStandardDetailsEntityTimeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DqStandardDetailsEntityTimeCriteria that = (DqStandardDetailsEntityTimeCriteria) o;
        return
    ...
    public String toString() {
        return "DqStandardDetailsEntityTimeCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
