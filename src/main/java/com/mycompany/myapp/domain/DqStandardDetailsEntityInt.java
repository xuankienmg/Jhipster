...
/**
 * A DqStandardDetailsEntityInt.
 */
@Entity
@Table(name = "dq_standard_details_entity_int")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class DqStandardDetailsEntityInt implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("dqStandardDetailsEntityInts")
    ...
    public DqStandardDetailsEntityInt stdAttributeName(String stdAttributeName) {
    ...
    public DqStandardDetailsEntityInt stdAttributeValue(Integer stdAttributeValue) {
    ...
    public DqStandardDetailsEntityInt std(DqStandards dqStandards) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DqStandardDetailsEntityInt)) {
            return false;
        }
        return id != null && id.equals(((DqStandardDetailsEntityInt) o).id);
    }
