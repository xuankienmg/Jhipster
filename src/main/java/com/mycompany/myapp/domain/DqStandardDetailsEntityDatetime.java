...
/**
 * A DqStandardDetailsEntityDatetime.
 */
@Entity
@Table(name = "datetime")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class DqStandardDetailsEntityDatetime implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("dqStandardDetailsEntityDatetimes")
    ...
    public DqStandardDetailsEntityDatetime stdAttributeName(String stdAttributeName) {
    ...
    public DqStandardDetailsEntityDatetime stdAttributeValue(Instant stdAttributeValue) {
    ...
    public DqStandardDetailsEntityDatetime std(DqStandards dqStandards) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DqStandardDetailsEntityDatetime)) {
            return false;
        }
        return id != null && id.equals(((DqStandardDetailsEntityDatetime) o).id);
    }
